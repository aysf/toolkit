...
var uploadTests = []struct {
	...
	{name: "not allowed file", allowedTypes: []string{"image/jpeg"}, renameFile: false, errorExpected: true},
}
...
var slugTests = []struct {
	...
	{name: "japanese string and roman characters", s: "Helo こんにちは世界 World", expected: "helo-world", errorExpected: false},
}
